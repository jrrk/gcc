...
static inline cil_stmt_iterator cil_iter_start (cil_seq);
static inline cil_stmt_iterator cil_iter_start_bb (basic_block);
static inline cil_stmt_iterator cil_iter_last (cil_seq);
static inline cil_stmt_iterator cil_iter_last_bb (basic_block);
static inline bool cil_iter_end_p (cil_stmt_iterator);
static inline bool cil_iter_one_before_end_p (cil_stmt_iterator);
static inline bool cil_iter_first_p (cil_stmt_iterator);
static inline void cil_iter_next (cil_stmt_iterator *);
static inline void cil_iter_prev (cil_stmt_iterator *);
static inline cil_stmt cil_iter_stmt (cil_stmt_iterator);
static inline cil_stmt *cil_iter_stmt_ptr (cil_stmt_iterator *);
static inline basic_block cil_iter_bb (cil_stmt_iterator);
static inline cil_seq cil_iter_seq (cil_stmt_iterator);

enum cil_iter_iterator_update
{
  CIL_ITER_NEW_STMT,		/* Only valid when single statement is added, move
			   iterator to it.  */
  CIL_ITER_SAME_STMT,	/* Leave the iterator at the same statement.  */
  CIL_ITER_CONTINUE_LINKING	/* Move iterator to whatever position is suitable
			   for linking other statements in the same
			   direction.  */
};

extern cil_seq cil_iter_split_seq_after (cil_stmt_iterator);
extern cil_seq cil_iter_split_seq_before (cil_stmt_iterator *);
extern void cil_iter_replace (cil_stmt_iterator *, cil_stmt);
extern void cil_iter_insert_before (cil_stmt_iterator *, cil_stmt,
			       enum cil_iter_iterator_update);
extern void cil_iter_insert_seq_before (cil_stmt_iterator *, cil_seq,
				   enum cil_iter_iterator_update);
extern void cil_iter_insert_after (cil_stmt_iterator *, cil_stmt,
			      enum cil_iter_iterator_update);
extern void cil_iter_insert_seq_after (cil_stmt_iterator *, cil_seq,
				  enum cil_iter_iterator_update);
extern void cil_iter_remove (cil_stmt_iterator *);
extern cil_stmt_iterator cil_iter_for_stmt (cil_stmt);
extern void cil_iter_move_after (cil_stmt_iterator *, cil_stmt_iterator *);
extern void cil_iter_move_before (cil_stmt_iterator *, cil_stmt_iterator *);
extern void cil_iter_move_to_bb_end (cil_stmt_iterator *, basic_block);
