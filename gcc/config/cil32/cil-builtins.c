  ...
  if (cil32_va_list_type == NULL_TREE)
    {
      ...
      type_decl = build_decl (BUILTINS_LOCATION, TYPE_DECL, get_identifier ("__arg_iterator"),
			      record);

      f_dummy = build_decl (BUILTINS_LOCATION, FIELD_DECL, get_identifier ("__dummy"),
			    ptr_type_node);
  ...
  if (cil32_complex_char_type == NULL)
    {
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, char_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, char_type_node);
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, unsigned_char_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, unsigned_char_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, short_integer_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, short_integer_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, short_unsigned_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, short_unsigned_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, integer_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, integer_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, unsigned_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, unsigned_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, long_long_integer_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, long_long_integer_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, long_long_unsigned_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, long_long_unsigned_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, float_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, float_type_node);
      TREE_CHAIN (imag) = real;
      ...
      real = build_decl (BUILTINS_LOCATION, FIELD_DECL, real_id, double_type_node);
      imag = build_decl (BUILTINS_LOCATION, FIELD_DECL, imag_id, double_type_node);
      TREE_CHAIN (imag) = real;
