...
struct GTY((chain_next ("%h.next"), chain_prev ("%h.prev"))) cil_seq_node_d
{
  cil_stmt stmt;
...
struct GTY ((chain_next ("%h.next_free"))) cil_seq_d
{
