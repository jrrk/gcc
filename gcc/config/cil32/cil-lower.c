...
{
  cil_stmt_iterator csi = cil_iter_start (init_seq);

  while (!cil_iter_end_p (csi))
    {
      cil_stmt stmt = cil_iter_stmt (csi);
      ...
      while (!cil_iter_end_p (csi))
	{
	  ...
	  switch (opcode)
	    ...
	    case CIL_ADD:
	      ...
	      if (cil_vector_p (top))
		cil_iter_replace (&csi, lower_cil_vector_add (top));
	    ...
	    case CIL_SUB:
	      ...
	      if (cil_vector_p (top))
		cil_iter_replace (&csi, lower_cil_vector_sub (top));
	    ...
	    case CIL_AND:
	      ...
	      if (cil_vector_p (top))
		cil_iter_replace (&csi, lower_cil_vector_and (top));
	    ...
	    case CIL_OR:
	      ...
	      if (cil_vector_p (top))
		cil_iter_replace (&csi, lower_cil_vector_or (top));
	    ...
	    case CIL_XOR:
	      ...
	      if (cil_vector_p (top))
		cil_iter_replace (&csi, lower_cil_vector_xor (top));
